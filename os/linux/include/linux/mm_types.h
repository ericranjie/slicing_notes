 ...
 * @_folio_dtor: Which destructor to use for this folio.   // @slice: 带_的都是私有函数/变量
 ...
 * of bytes.  It is a power-of-two in size, and it is aligned to that    // @slice: foilo命名的来源 -> pow(2)
 * same power-of-two.  It is at least as large as %PAGE_SIZE.  If it is  // @slice: 最小值 = PAGE_SIZE
...
struct folio {
	...
	union { // @slice: 第三union 主要用于hugetlb
		struct {
